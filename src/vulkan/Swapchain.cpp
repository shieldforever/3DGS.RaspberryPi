...
void Swapchain::createSwapchain() {
    ...
    // Fallback if R8G8B8A8 is not found
    ...
    uniqueQueueFamilies.insert(context->queues[VulkanContext::Queue::COMPUTE].queueFamily);
    uniqueQueueFamilies.insert(context->queues[VulkanContext::Queue::PRESENT].queueFamily);
